...
import ScreenDetailPartTwo from './ScreenDetailPartTwo';

class DetailPartTwo extends Component{
  ...
  render(){
    ...
    if (isLoaded && detailPart && detailExamQuestion) {
      return <ScreenDetailPartTwo detailExamQuestion={detailExamQuestion} detailPart={detailPart} />
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailPartTwo);