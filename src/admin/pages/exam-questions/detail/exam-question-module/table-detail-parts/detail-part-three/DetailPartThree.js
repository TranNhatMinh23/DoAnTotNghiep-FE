...
import ScreenDetailPartThree from './ScreenDetailPartThree';

class DetailPartThree extends Component{
  ...
  render(){
    ...
    if (isLoaded && detailPart && detailExamQuestion) {
      return <ScreenDetailPartThree detailExamQuestion={detailExamQuestion} detailPart={detailPart} />
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailPartThree);