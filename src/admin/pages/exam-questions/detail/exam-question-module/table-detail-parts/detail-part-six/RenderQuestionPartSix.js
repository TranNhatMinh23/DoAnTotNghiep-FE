...
import GroupUploadWithInput from './GroupUploadWithInput';
import { withTranslation } from 'react-i18next';

class RenderQuestionPartSix extends PureComponent {
  state = {
          ...
          return (
            <WidgetQuestion key={question.id}>
              {question.isFirstGroup &&
                <GroupUploadWithInput
                  question={question}
                  onChangeGroupDescription={this.onChangeGroupDescription}
                />
              }
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation()(RenderQuestionPartSix));