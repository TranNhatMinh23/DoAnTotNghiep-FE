...
import styles from './RenderQuestionPartFour.module.css'; 
import { updateQuestionTextInList, getAnswerKey, getItemById } from '../../../../../../../shared/function';
import { withTranslation } from 'react-i18next';

class RenderQuestionPartFour extends PureComponent {
  state = {
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation()(RenderQuestionPartFour));