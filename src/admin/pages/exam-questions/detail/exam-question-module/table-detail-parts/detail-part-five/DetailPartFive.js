...
import ScreenDetailPartFive from './ScreenDetailPartFive';

class DetailPartFive extends Component{
  ...
  render(){
    ...
    if (isLoaded && detailPart && detailExamQuestion) {
      return <ScreenDetailPartFive detailExamQuestion={detailExamQuestion} detailPart={detailPart} />
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailPartFive);