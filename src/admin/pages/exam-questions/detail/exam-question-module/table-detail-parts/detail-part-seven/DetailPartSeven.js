...
import ScreenDetailPartSeven from './ScreenDetailPartSeven';

class DetailPartSeven extends Component{
  ...
  render(){
    ...
    if (isLoaded && detailPart && detailExamQuestion) {
      return <ScreenDetailPartSeven detailExamQuestion={detailExamQuestion} detailPart={detailPart} />
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailPartSeven);