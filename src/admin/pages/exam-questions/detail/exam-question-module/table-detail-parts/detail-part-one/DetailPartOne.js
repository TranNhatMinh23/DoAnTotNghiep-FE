...
import ScreenDetailPartOne from './ScreenDetailPartOne';
import NotFoundPage from '../../../../../../components/not-found/NotFound';
import Loading from '../../../../../../components/loading/Loading';

class DetailPartOne extends Component{ 
  componentDidMount() {
  ...
  render(){
    ...
    if (isLoaded && detailPart && detailExamQuestion) {
      return <ScreenDetailPartOne detailExamQuestion={detailExamQuestion} detailPart={detailPart} />
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailPartOne);