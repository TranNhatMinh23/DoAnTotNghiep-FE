...
class AvatarAdmin extends Component {
  state = {
    currentFile: null
  }
  ...
  componentWillReceiveProps(nextProps) {
    if (!nextProps.isLoadingUploadAvatar && !nextProps.err) {
      readURL("avatarAdminImg", this.state.currentFile);
    }
  }
  ...
  render() {
    ...
    return (
      <div className={styles.widgetAvatar}>
        <div className={styles.previewAvatar}>
          {
            isLoadingUploadAvatar ?
              ...
              : userInfo.avatar_url ?
                <img id="avatarAdminImg" src={process.env.REACT_APP_URL_API+ userInfo.avatar_url} alt="" />
                :
        ...
        />
        <Button type="primary">
          <label htmlFor="avatarAdmin" className={styles.labelInputFile}>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation()(AvatarAdmin));