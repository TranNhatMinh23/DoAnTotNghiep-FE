...
import styles from './AccountInfomation.module.css';
        ...
        <div className="col-md-8">
          <Form {...formItemLayout} onSubmit={this.handleSubmit}>
            ...
            <Form.Item label={t('dateOfBirth')} className={styles.chooseBirthday}>
              ...
              })(<DatePicker onChange={this.onChangeBirthday} className={styles.chooseBirthday} format={dateFormat} placeholder={t('selectDate')} />)}
            </Form.Item>
...
const WrappedAccountForm = Form.create({ name: 'AccountInfomation' })(AccountInfomation);
