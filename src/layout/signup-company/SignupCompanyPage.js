...
import styles from './SignupCompanyPage.module.css';
...
class SignupCompanyPage extends Component {
  render() {
...
export default connect(mapStateToProps, null)(withTranslation()(SignupCompanyPage));