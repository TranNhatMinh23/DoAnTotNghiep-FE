...
const WrappedSecurityForm = Form.create({ name: 'change-password' })(SecurityInfomation);

WrappedSecurityForm.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation()(WrappedSecurityForm));