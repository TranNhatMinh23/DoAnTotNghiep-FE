...
class ScreenViewPartThree extends Component {
  renderListQuestions = () => {
    const { listQuestionPart3, listResult } = this.props;
...
ScreenViewPartThree.propTypes = {
  listQuestionPart3: PropTypes.array
};

export default ScreenViewPartThree;